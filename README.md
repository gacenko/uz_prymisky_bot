...
**Відсічка 09:00** (`CUTOFF_TIME`): якщо перерахований час відправлення з
Княжичі все одно виходить раніше 9 ранку — сповіщення не шлеться, бо
запізнення не критичне для ранкової поїздки. Якщо затримка настільки велика,
що перерахований час переходить за 9:00 — сповіщення йде з новим часом.
